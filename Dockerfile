FROM ditissdocker/alma_cdac:8.10
MAINTAINER maintainer="ditissgithub"
...
ARG xcat_baseos=rh8
#https://xcat.org/files/xcat/xcat-core/2.17.x_Linux/xcat-core/xcat-core-2.17.0-linux.tar.bz2
